# Move delete_todo_by_id to session_persistence class and rename to delete_todo_from_list
...
# Removed find_list_by_id to persistence class
...
# Moved mark_all_completeed to session_persistence and rename to mark_all_todoso_completed
