...
class RomanNumeralsTest(unittest.TestCase):
    ...
    def test_1024(self):
        number = RomanNumeral(1875)
        self.assertEqual(number.to_roman(), "MDCCCLXXV")
    ...
    #     number = RomanNumeral(1990)
    #     places = number._count_places()
    #     for pairs in places.items():
    #         print(pairs)
    #         print(number._place_to_numeral(pairs))
